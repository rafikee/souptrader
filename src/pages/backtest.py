...
def create_layout():
    ...
    return html.Div([
        ...
        html.Div([
            ...
            # Loading indicator right after the button (fixed position)
            dcc.Loading(
                id="loading-backtest",
                type="default",
                children=html.Div(id='loading-placeholder', style={'height': '0px'})
            )
        ...
        # Results section (separate from loading indicator)
        html.Div([
...
def run_backtest_callback(n_clicks, ticker, strategy, filters, stop_loss, trailing_stop, take_profit):
    ...
    try:
        ...
        return (html.Div([summary_card, log_output]), html.Div())
